...
This project is indexed by GitNexus as **futuapi4go-demo** (1072 symbols, 1111 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
